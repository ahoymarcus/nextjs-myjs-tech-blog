      ...
      <Head>
		...
		<section className={styles.asideSection}>
			...
			<div className={styles.testimonialSection}>
				...
				<span className={styles.testimonialSection__text}>It also provides a rich library of various JavaScript modules to simplify the development of web applications and has features like:</p>
