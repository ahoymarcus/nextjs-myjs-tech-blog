...
5. **ITIL Continual Service**: this is the life cycle that is close to the notion of continous delivering. **It only has one process that is divided into 7 steps** (7 Step Process Improvement).   
