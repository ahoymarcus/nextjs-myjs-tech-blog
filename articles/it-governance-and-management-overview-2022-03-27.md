...
4. ##### Methodology Indicators
    4.1. KPI Indicator   
    4.2. OKR Indicator   
    4.3. Balance ScoreCard (BSC) Indicator
5. ##### Kinds of Management Tools
    5.1. SWOT Analysis   
    5.2. RACI Matrix
...
2. **Schedule, costs and scope management**
3. **Communication**
...
5. **Directive PMO**: this one is the most enforcing kind there is, where comes from its responsability many, and even most, of the directives demanded from the teams.   
    ...
    5.3. Defines the management for the teams.
...
And, as it can be seem in the image above, the COBIT framework joins **37 Processes** along those same **5 Domains** to devise its successfully script for Governance and Management and enterprise; and that in its division, the domains conform as 1 count for Governance, while 4 counts for Management.
...
4. **(BAI04) Manage availability and Capability**
