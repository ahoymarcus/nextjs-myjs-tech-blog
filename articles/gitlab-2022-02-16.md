...
7. ##### Advanced GIT
	...
	7.4. GIT merge    
	7.5. GIT rebase Versus GIT merge: Which is Better?
...
1. [Git Cheat Sheets - Training.Github.com](https://training.github.com/)
2. [Git Branching from Peter Cottle - Learngitbranching.js.org/](https://learngitbranching.js.org/)
3. [Commit Often, Perfect Later, Publish Once: Git Best Practices](https://sethrobertson.github.io/GitBestPractices/)
4. [Git Branching and Tagging Best Practices on SO](https://softwareengineering.stackexchange.com/questions/165725/git-branching-and-tagging-best-practices)
5. [Git Best Practices: Workflow Guidelines](https://www.lullabot.com/articles/git-best-practices-workflow-guidelines)
6. [Understanding Git Conceptually](https://www.sbf5.com/~cduan/technical/git/)
7. [Top 10 Git Tutorials for Beginners - Webfx.com](https://www.webfx.com/blog/web-design/git-tutorials-beginners/)
8. [Git Immersion](https://gitimmersion.com/lab_01.html): this is another great tutorial to learn the shortcuts of git (if you are willing to learn some Ruby).
9. [Contributing to Open Source Part II: The Real Way - The Odin Project](https://www.youtube.com/watch?v=mENDYhfxH-o): a descriptive video lesson on how to become a contributor to the platform.
