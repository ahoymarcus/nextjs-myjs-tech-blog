...
2. ##### Organizing the JavaScript Code
    ...
    2.5. ES6 Modules
3. ##### Linting
    3.1. Some Popular Linting Tools and JavaScript Style Guides    
    3.2. Using JSHint on Node.js
4. #####
5. #####
6. ##### Further Reading
7. ##### References
...
Linting is a process of looking through the code and cleaning it up. So, it's a code quality tool set which can automatically find mistakes and inconsistences and fix or alert about it.

And in a more speciffic terms, linting is **"a tool for static code analysis and therefore part of white-box testing. The main purpose of white-box testing is to analyse the internal structure of components or a system""** [How linting and ESLint improve code quality - Hackermoon.com](https://hackernoon.com/how-linting-and-eslint-improve-code-quality-fa83d2469efe). 


And, linting certainly brings some important advantages like:

1. To prevent certain types of bugs, including a few of catastrophic ones.
2. It helps in the workload and improves its performance.
3. It results in a cleaner code.


But there is still one more important reason that it is help the developer to improve his code habits while the tool is constantly tipping off during the work and the practices.


Finally, in the article [Javascript Linting: What Developers Need to Know](https://mikecavaliere.com/javascript-linting-what-developers-need-to-know/), the author also points out some certain types of "code smells" that can lead to future common problems:

1. **Works in development, breaks in production**: so, as the author says, most of modern web stacks support minification, but minifiers won't tell you when you're missing semicolons, and neither will the browser, though a missing semicolon can break minified JavaScript.   
    1.1. Also, this is a kind of difficult problem to trace since the code will still be working in the development.
2. **Scope conflicts**: again, there are many instances where some minor mistakes like forgeting to properly declare variables or, on the contrary, have unused variables in the code base that can represent future problem.
3. **XSS security holes**
4. **Code readability problems**



#### Some Popular Linting Tools and JavaScript Style Guides

1. [JSHint](https://jshint.com/)   
    1.1. JSHint also has a online testing code available at this same main address.   
    1.2. A Notepad++ plugin that allows users to run JSLint (The JavaScript Code Quality Tool) against their open JavaScript files: [JSHint for Notepad++](https://sourceforge.net/projects/jslintnpp/)   
    1.3. "Yay semicolons!"
2. [JSlint](https://www.jslint.com/):   
    2.1. "Yay semicolons!"
3. [ESLint](https://eslint.org/):   
    3.1. [Getting Started with ESLint - Docs](https://eslint.org/docs/latest/user-guide/getting-started)
4. [Airbnb Style Guide](https://github.com/airbnb/javascript):   
    1.1. "Yay semicolons!"
5. [Google style guide for JavaScript](https://google.github.io/styleguide/jsguide.html):    
    2.1. "Yay semicolons!"
...
#### Using JSHint on Node.js

Each release of JSHint is published to [npm](https://www.npmjs.com/search?q=JSHint), and it can be installed globally by:

```
$ npm install -g jshint
``` 

And then it's just to use its command-line interface. It can also be usend on single projects, like installing JSHint as a development dependency for a Node.js project:
...
- [Javascript Linting: What Developers Need to Know - Mikecavaliere.com](https://mikecavaliere.com/javascript-linting-what-developers-need-to-know/)

- [How linting and ESLint improve code quality - Hackermoon.com](https://hackernoon.com/how-linting-and-eslint-improve-code-quality-fa83d2469efe)
